        ...
        <div className="z-10 fixed w-full">
            ...
            <div style={{backgroundColor: nav <= 40 ? "transparent" : "white",color: nav <= 40 ? "white" : "black"}} 
                ...
                <div className="flex-1 flex justify-end">
                    <button style={{color: nav <= 40 ? "white" : "black"}} className=" text-2xl mx-2"><MdOutlineSearch /></button>
                    <button style={{color: nav <= 40 ? "white" : "black"}} onClick={()=> setOpenmenu(!openmenu)} className=" text-2xl mx-2"><MdOutlineMenu /></button>
                </div>
            </div>
