      ...
      <MouseParallaxContainer globalFactorX={0.1} globalFactorY={0.1}>
        ...
        <div className="absolute top-20 right-0">
          <MouseParallaxChild factorX={-0.3} factorY={-0.9}>
            <img alt="pic" src="/images/dowfd434nload.png" />
          </MouseParallaxChild>
        </div>

        <div className="absolute top-40 right-0">
          <MouseParallaxChild factorX={-0.3} factorY={-0.5}>
            <img alt="pic" src="/images/down6565tload.png" />
          </MouseParallaxChild>
        </div>

        <div className="absolute top-40 left-0">
          <MouseParallaxChild factorX={-0.5} factorY={-0.6}>
            <img alt="pic" src="/images/dowhhghgz321nload.png" />
          </MouseParallaxChild>
        </div>
          ...
          <MouseParallaxChild factorX={0.2} factorY={-0.2}>
            ...
            <div style={{position:"absolute",left:"-20%",top:"50vh"}}>
                <MouseParallaxChild factorX={-0.9} factorY={-0.9}>
                  <img alt="pic" src="/images/dgfg3xownload.png" />
                </MouseParallaxChild>
            </div>
