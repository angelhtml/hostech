        ...
        xl:flex-row">
          ...
          <MouseParallaxChild factorX={0.2} factorY={-0.2}>
            <div className="flex justify-center">
                <span style={{width:"auto"}} className="flex justify-center p-2 rounded-full text-lg text-orange-500 border-2 border-orange-500">
                ...
                <div style={{zIndex:"1"}} className="flex flex-col w-3/4">
                    ...
                    xl:flex-row">
                        <div className="flex-1 flex justify-center">
                            <button className="flex text-white font-medium bg-orange-400 p-3 px-6 rounded-full text-lg">Start Free <MdArrowRightAlt className="text-3xl mx-2"/></button>
                        </div>
